    ...
    <!-- Begin page content -->
      <div class="container" id='tes'>
        <div class="page-header">
          <h1>Edit Anggota Berdasarkan NIM</h1>
        </div>
        <p class="lead">Cari Anggota kemudian edit data anggota tersebut berdasarkan NIM. Pastikan bahwa anda memasukkan <code>NIM</code> dengan benar.</p>
        <div class="container">
          <div class="row">
